...
//  CONSTANTS
//---------------------------------------------------------
export const APP_NAME = 'soundcloud-react-redux';
...
export const CLIENT_ID = process.env.SOUNDCLOUD_CLIENT_ID || '1fb0d04a94f035059b0424154fd1b18c';
...
//  PLAYER
//-------------------------------------
export const PLAYER_INITIAL_VOLUME = 50;
...
export const FEATURED_TRACKLIST_USER_ID = 308905856;
